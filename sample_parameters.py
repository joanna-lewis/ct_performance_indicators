...
A_f = np.zeros(n_sample)
S_f = np.zeros(n_sample)
...
for i in xrange(n_sample):
    ...
    A_f[i] = A_fun(inc_f[i]*p_asymp_f[i], 
            sc_f[i] + scr_f[i]*p_true_pos_f[i], 
            inc_f[i]*(1-p_asymp_f[i]), 
            scr_f[i]*p_true_pos_f[i] + att_symp[i]*p_true_pos_f[i]
        )
    S_f[i] = S_fun(inc_f[i]*p_asymp_f[i], 
            sc_f[i] + scr_f[i]*p_true_pos_f[i], 
            inc_f[i]*(1-p_asymp_f[i]), 
            scr_f[i]*p_true_pos_f[i] + att_symp[i]*p_true_pos_f[i]
        )
